    ...
    modal.innerHTML = `
        ...
        <div class="modal-content">
            ...
            <div class="modal-right">
                ...
                <p><strong>ВАЖНО: НА САЙТЕ ВСЕ ТОВАРЫ СО СКИДКОЙ 5% ПРИ ЗАКАЗЕ ЧЕРЕЗ НОМЕР ТЕЛЕФОНА НУЖНО СООБЩИТЬ ЧТО ВЫ ЗВОНИТЕ С САЙТА ЧТОБЫ ПОЛУЧИТЬ СКИДКУ. Вы можете позвонить по номеру телефона - Марина:</strong> +79493420947</p>
